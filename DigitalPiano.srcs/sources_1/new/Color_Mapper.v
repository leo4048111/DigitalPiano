...
module  color_mapper (input clk,
						...
						input        [15:0]keycode,
						input logic  [2:0] OctaveSelect,
														Tone,
                       	output logic [7:0] VGA_R, VGA_G, VGA_B // VGA RGB output							  input logic  [2:0] Tone
                     );
   
    logic 		ball_on;
    logic [7:0]Red, Green, Blue;
	 logic [8:0]tempRed, tempGreen, tempBlue;


	 logic      memBigPiano[0:12614];
	 logic      memPianoBackground[0:10961];
	 logic      memPianoBackgroundHighC[0:11831];
	 logic      memCurrentOctave[0:15514];
	 logic      memCurrentOctaveHighC[0:14551];

	 logic      memButtonSine [0:5503];
	 logic      memButtonSquare [0:5503];
	 logic      memButtonSaw [0:5503];
	 logic      memButtonOrgan [0:5503];
	 logic      memButtonSineCos [0:5503];
	 
	 logic      memLetterA [0:857];
	 logic      memLetterW [0:857];
	 logic      memLetterS [0:857];
	 logic      memLetterE [0:857];
	 logic      memLetterD [0:857];
	 logic      memLetterF [0:857];
	 logic      memLetterT [0:857];
	 logic      memLetterG [0:857];
	 logic      memLetterY [0:857];
	 logic      memLetterH [0:857];
	 logic      memLetterU [0:857];
	 logic      memLetterJ [0:857];
	 logic      memLetterK [0:857];	
	 logic      data_from_Big_Piano;
	 logic      data_from_Piano_octave;
	 logic      data_from_Piano_octave_High_C;
	 logic      data_from_Piano_Current_Octave;
 	 logic      data_from_Piano_Current_Octave_High_C;

	 logic      data_from_ButtonSine;
	 logic      data_from_ButtonSquare;
	 logic      data_from_ButtonSaw;
	 logic      data_from_ButtonOrgan;
	 logic      data_from_ButtonSineCos;
	 
	 logic      data_from_LetterA;
	 logic      data_from_LetterW;
	 logic      data_from_LetterS;
	 logic      data_from_LetterE;
	 logic      data_from_LetterD;
	 logic      data_from_LetterF;
	 logic      data_from_LetterT;
	 logic      data_from_LetterG;
	 logic      data_from_LetterY;
	 logic      data_from_LetterH;
	 logic      data_from_LetterU;
	 logic      data_from_LetterJ;
	 logic      data_from_LetterK;
	 logic[3:0] key0;
	 logic[3:0] key1;
	 logic[7:0] BigOffsetX = 8'b01100100; //100;
	 logic[7:0] BigOffsetY = 8'b11001000; //200;
	 logic[7:0] ButtonOffsetX = 8'b00100011; //35;
	 logic[7:0] ButtonOffsetY = 8'b01111100; //124;
